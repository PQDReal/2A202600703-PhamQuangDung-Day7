...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        for piece in pieces:
            piece_with_separator = piece if separator == " " else piece
            candidate = (
                piece_with_separator
                if not current_chunk
                else f"{current_chunk}{separator}{piece_with_separator}"
            )
            ...
            if len(piece_with_separator) <= self.chunk_size:
                current_chunk = piece_with_separator
            else:
                chunks.extend(self._split(piece_with_separator, rest))
